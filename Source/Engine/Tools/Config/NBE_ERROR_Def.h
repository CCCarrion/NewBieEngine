...
//Windows Error
#define NBE_ERROR_WINDOWS_BASE_VALUE NBE_ERROR_OS_BASE_VALUE | (1LL<<24)

//Render Error
#define NBE_ERROR_RENDER_BASE_VALUE (2LL<<32)
#define NBE_ERROR_RENDER_BASE_RESOURCE_IS_NULL NBE_ERROR_RENDER_BASE_VALUE+1

//DX12 Error 
#define NBE_ERROR_DX12_BASE_VALUE  NBE_ERROR_RENDER_BASE_VALUE | (1LL<<24)
